...
class Wishlist(BaseModel):
    ...
    # Relationships with eager loading
    user = relationship("User", back_populates="wishlist", lazy="selectin")
    product = relationship("Product", back_populates="wishlist", lazy="selectin")
...
class OrderItem(BaseModel):
    ...
    variant = relationship("ProductVariant", back_populates="order_items", lazy="selectin")
