...
-- ALTER TABLE wishlist ADD updated_at TIMESTAMP;
-- ALTER TABLE notifications ADD COLUMN updated_at TIMESTAMP;
-- ALTER TABLE product_images ADD COLUMN updated_at TIMESTAMP;
-- ALTER TABLE product_attributes ADD COLUMN created_at TIMESTAMP;
-- ALTER TABLE product_attributes ADD COLUMN updated_at TIMESTAMP;
...
-- ALTER TABLE coupons ADD COLUMN updated_at TIMESTAMP;
...
-- ALTER TABLE features  ADD COLUMN updated_at TIMESTAMP;
-- ALTER TABLE stats  ADD COLUMN updated_at TIMESTAMP;
-- ALTER TABLE social_links  ADD COLUMN updated_at TIMESTAMP;
-- ALTER TABLE quick_link_categories  ADD COLUMN updated_at TIMESTAMP;
-- ALTER TABLE quick_links  ADD COLUMN updated_at TIMESTAMP;
-- ALTER TABLE payment_methods  ADD COLUMN updated_at TIMESTAMP;
-- ALTER TABLE contact_info  ADD COLUMN updated_at TIMESTAMP;
-- ALTER TABLE promo_messages  ADD COLUMN updated_at TIMESTAMP;
-- ALTER TABLE suppliers  ADD COLUMN updated_at TIMESTAMP;
-- ALTER TABLE stores  ADD COLUMN updated_at TIMESTAMP;
-- ALTER TABLE store_services  ADD COLUMN updated_at TIMESTAMP;
-- ALTER TABLE search_queries  ADD COLUMN updated_at TIMESTAMP;
-- ALTER TABLE traffic_sources  ADD COLUMN updated_at TIMESTAMP;
-- ALTER TABLE recent_activity  ADD COLUMN updated_at TIMESTAMP;
...
-- ALTER TABLE conversion_funnel  ADD COLUMN updated_at TIMESTAMP;

-- Table for hero images
...
-- Table for hero content configuration
...
-- ALTER TABLE newsletter_subscribers ADD COLUMN created_at TIMESTAMP;
-- ALTER TABLE hero_images ADD COLUMN updated_at TIMESTAMP;
-- ALTER TABLE hero_config ADD COLUMN updated_at TIMESTAMP;
-- ALTER TABLE hero_buttons ADD COLUMN updated_at  TIMESTAMP;
-- ALTER TABLE hero_price_tags ADD COLUMN updated_at TIMESTAMP;
